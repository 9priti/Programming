...
public class ArrayListContainsTest {
	...
	/**
	 * * Function to test if Array contains a certain value or not. This method
	 * take advantage of * contains() method of ArrayList class, by converting
	 * array to ArrayList. * * @return true if array contains
	 */
	...
	/**
	 * * Another method to search an item in Java array. This method loop
	 * through array and use * equals() method to search element. This actually
	 * performs a linear search over array in Java * *@return true if array has
	 * provided value.
	 */
